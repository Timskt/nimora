...
| Auto Mode | 在 Tool、Capability、风险、数据、费用、时间、步骤和并发预算交集内自动推进 | Supervisor 领域、SQLite 会话和 CLI 控制面已实现 | Provider/Tool 执行循环、桌面控制与真实执行端到端验证 |
