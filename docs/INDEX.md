...
- 每个公开契约使用独立版本：`deskpet.event/1`、`deskpet.skill/1`、`deskpet.asset/1`。
...
任何新功能评审必须覆盖：产品价值、视觉与交互、设计令牌与组件状态、数据模型、权限隐私、离线行为、失败恢复、性能预算、可观测性、跨平台、无障碍、国际化、部署升级、测试、兼容迁移和生态影响。UI 质量以 [`UI_DESIGN_SYSTEM.md`](UI_DESIGN_SYSTEM.md) 为强制门禁，功能储备以 [`FEATURE_EVOLUTION.md`](FEATURE_EVOLUTION.md) 管理，未经里程碑决策不构成发布承诺。
