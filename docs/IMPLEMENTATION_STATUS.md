...
|---|---|---|---|
| 桌宠窗口与交互 | 部分实现 | Tauri 透明双窗口、拖拽、置顶、穿透、托盘、安全模式、Click/Drag FSM、经典单击/双击/长按/右键仲裁、三类照料、30 秒冷却；Affinity/BondPoints 双轨长期成长、旧快照迁移、标准成长事件、SQLite 原子持久化与真实关系卡均有 Rust/TS 测试；`DESKTOP_PET_EXPERIENCE.md` 已确立经典 QQ 宠物式独立桌面生命体基线 | 抚摸轨迹与径向菜单、饱腹/清洁等完整 Needs、任务协作成长、关系阶段与纪念册、环境降扰、Windows/macOS 多屏/DPI、WebView 崩溃恢复与 8 小时长稳验证 |
